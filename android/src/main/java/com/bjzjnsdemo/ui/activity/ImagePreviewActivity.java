...
public class ImagePreviewActivity extends AppCompatActivity {
    ...
    public static String EXTRA_SELECTED_IMAGE_POSITION = "extra_selected_image_position";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentPosition = getIntent().getIntExtra(EXTRA_SELECTED_IMAGE_POSITION, 0);         //默认的图片显示位置
