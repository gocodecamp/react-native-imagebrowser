package com.bjzjnsdemo.ui.view;
...
public class SimplePhotoView extends PhotoView {
    ...
    public SimplePhotoView(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public SimplePhotoView(Context context, AttributeSet attr, int defStyle) {
